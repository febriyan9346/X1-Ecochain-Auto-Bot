                ...
                try:
                    ...
                    if faucet_result.get('success'):
                       print("[{}] {}[SUCCESS] Task: Faucet Claim | Status: Success{}".format(time_str, Fore.GREEN, Style.RESET_ALL))
                        ...
                        print("[{}] {}[ERROR] Task: Faucet Claim | Status: Failed{}".format(time_str, Fore.RED, Style.RESET_ALL))
                    ...
                    print("[{}] {}[SUCCESS] Total Points: {:,} | Rank: #{} | Today: +{}{}".format(time_str, Fore.GREEN, final_points, rank, points_gained, Style.RESET_ALL))
